...
Access to areas where confidential information is processed or stored is restricted to authorized individuals only by implementing appropriate access controls (EXAMPLE: two-factor authentication with access card and PIN).
...
Physical Security Policy Relevant ISO27001 Controls Mapping

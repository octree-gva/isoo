...
The company is a fully remote working company.
...
- When working away from a home office, to not use public open networks when connecting to services and where necessary and applicable to utilise VPN technology.
...
It is company policy to allow home working. Adequate technical controls are in place to protect company information, but the following is provided as guidance when home working:

- Where possible and feasible to work from an area separate to the main home

- If home printing is required to ensure it is handled and destroyed in line with the Information Classification and Handling Policy which may include the requirement for a home shredder.

## Mobile Policy

- SAMPLE Company-managed laptops with full-disk encryption; MDM enforced; personal devices not used for confidential data.
...
Mobile and Teleworking Policy Relevant ISO27001 Controls Mapping

...
- SAMPLE TLS 1.2+ for online transfer; SFTP for bulk files; encrypted USB only when approved exception.
...
Information Transfer Policy Relevant ISO27001 Controls Mapping

...
The purpose of this policy is to manage and mitigate the risk of Artificial Intelligence (AI).
...
- Guide: choose either option A or option B. If you choose Option A everything after Option A, up to Policy Compliance, can be deleted.

- Option A) The organisation does not approve the usage of AI Technology for Business Purposes
...
The following a list of authorised AI Technology:

- <list or name the AI Technology you have authorised and approved>
...
AI technology selected is based on its ability to meet the needs of the business.
...
- SAMPLE Only approved tools (e.g. enterprise Copilot) for non-confidential tasks; no customer PII in public LLM prompts.
...
- AI Usage is approved by the Head of IT.

- AI Usage in the organisation is by an approval process.

- A register of approvals is maintained.

- A log of users is maintained.

- Company data, internal data, confidential data, employee data or data of a sensitive nature can / cannot be input into AI Technology.
...
Guide: record the areas of the business that has approved the use of AI and the summary of allowed usage and restrictions. The table includes examples only. You should tailor this to your needs.
